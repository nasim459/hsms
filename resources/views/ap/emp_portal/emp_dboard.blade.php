...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Employee Dash Board | HSMS</title>
            ...
            <div id="header" class="header navbar navbar-default navbar-fixed-top b_t_header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        <a href="{{URL::to('emp-dboard')}}" class="navbar-brand"><img src="{{URL::asset('ap/assets/img/icon_1.jpg')}}" class="logo" alt="" /><span class="text-success">Emp Dash Board</span></a>
                    ...
                    <ul class="nav">
                        ...
                        <li class="has-sub m_t_40">
                            ...
                            <div class="col-md-2 col-md-offset-1">
                                <!-- begin widget -->
                                <p>
                                    <a href="{{URL::to('emp-dboard')}}" class="btn btn-lg btn-success widtg150">
