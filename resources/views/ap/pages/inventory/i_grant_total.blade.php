            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">
                        <strong>Income Grant Total</strong>
                    </h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <h4 class="m-t-10 text-center text-info">Income of All Building of This Month</h4>
                            <dl class="dl-horizontal m-b-20 f-s-14">
                                ...
                                <dd>2000000</dd>
                                <h5 class="text-left">
                                    <a href="{{URL::to('inventory-income')}}" class="btn btn-default btn-xs" title="Back To Income Bills"><i class="fa fa-arrow-left"> </i> Income </a>
                                </h5>
                            </dl>
                        </div>
                    </div><hr class="hr-d">
