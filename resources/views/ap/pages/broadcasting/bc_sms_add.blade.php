            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">
                        <a href="{{URL::to('broadcasting-sms')}}" class="btn btn-white btn-xs" title="Go Back">&nbsp;<i class="fa fa-arrow-left"></i>&nbsp;</a>  
                        <b> Create Your SMS To Send</b>
                    </h4>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <h4 class="">Make Your SMS, what you are talk.</h4>
                            </div>
                        </div>
                        <div class="form-group">
