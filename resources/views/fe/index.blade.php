...
<html>
    ...
    <body>
        <div class="page-wrapper">
            ...
            <header class="main-header header-style-one one-page-header">
                <div class="auto-container">
                    <div class="outer-box clearfix">
                        <!--Logo-->
                        <div class="logo"><a href="{{URL::to('front-end')}}"><img src="fe/images/logo-1.png" alt="Logo"></a></div>
            ...
            <section class="about-section" id="about-section">
                <div class="auto-container">
                    ...
                    <!--Full Image Box-->
                    <figure class="full-image-box"><img src="fe/images/resource/featured-image-1.jpg" alt=""></figure>
            ...
            <!--Parallax Section-->
            <section class="parallax-section" style="background-image:url(fe/images/parallax/image-1.jpg);">
                <div class="auto-container">
            ...
            <!--Testimonials-->
            <section class="testimonials-section" id="testimonials-section" style="background-image:url(fe/images/background/testimonials-bg.jpg);">
                <div class="auto-container">
            ...
            <!--Contact Section-->
            <section class="default-section faded-section contact-section" id="contact-section" style="background-image:url(fe/images/background/contact-bg.jpg);">
                <div class="auto-container">
                    <div class="row clearfix">
                        <!--Column-->
        ...
        <script src="fe/js/jquery.scrollTo.js"></script>
